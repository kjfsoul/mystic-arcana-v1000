...
const tarotCards = [
  {
    ...
    element: "air",
    keywords: ["beginnings", "journey", "potential", "freedom"],
  },
  {
    id: "magician",
    name: "The Magician",
  ...
  },
  {
    ...
    element: "water",
    keywords: ["willpower", "determination", "control", "success"],
  },
  {
    id: "strength",
    name: "Strength",
  ...
  },
  {
    ...
    element: "fire",
    keywords: ["fortune", "karma", "cycle", "destiny"],
  },
  {
    id: "justice",
    name: "Justice",
  ...
  },
  {
    ...
    element: "water",
    keywords: ["suspension", "sacrifice", "letting go", "new perspective"],
  },
  {
    id: "death",
    name: "Death",
  ...
  },
  {
    ...
    element: "air",
    keywords: ["hope", "faith", "spirituality", "renewal"],
  },
  {
    id: "moon",
    name: "The Moon",
  ...
  },
  {
    ...
    element: "fire",
    keywords: ["rebirth", "inner calling", "absolution", "judgement"],
  },
  {
    id: "world",
    name: "The World",
    arcana: "major",
    number: 21,
    upright: "Completion, accomplishment, travel, world consciousness",
...
const personas = {
  luna: {
    ...
    intro:
      "Greetings, dear seeker. I am Luna, guardian of the cosmic mysteries. The moon's wisdom flows through me, illuminating the hidden paths of your soul's journey.",
  },
  sage: {
    id: "sage",
    ...
    intro:
      "Welcome, student of the mysteries. I am Sage, keeper of ancient wisdom. Through centuries of study, I have learned to read the sacred symbols that guide your path.",
  },
  river: {
    id: "river",
    ...
    intro:
      "Hello, beautiful soul. I am River, flowing with compassion and understanding. Let me guide you through the gentle currents of your heart's wisdom.",
  },
  phoenix: {
    id: "phoenix",
    ...
    intro:
      "Rise up, warrior of change! I am Phoenix, forged in the flames of transformation. Together, we shall ignite the power within you to create the life you deserve.",
  },
};
...
const spreads = {
  three_card: {
    ...
    layout: "linear",
    descriptions: [
      "Past influences and foundation",
      "Current situation and energies",
      "Future potential and outcome",
    ],
  },
  celtic_cross: {
    id: "celtic_cross",
...
function initializeEventListeners() {
  ...
  document
    ...
    .addEventListener("click", shuffleAndDraw);
  ...
  document
    ...
    .addEventListener("click", readInterpretationAloud);

  // Save reading
  document
    .getElementById("save-reading")
  ...
  document
    ...
    .addEventListener("click", startNewReading);
...
function getPersonaIntroduction() {
  const personas = {
    ...
    river:
      "Feel the gentle flow of understanding as these cards reveal the emotional currents moving through your life. Trust in the healing power of this moment.",
    phoenix:
      "The flames of transformation burn bright in these cards! Prepare to rise from the ashes of your old self and embrace your magnificent potential.",
  };

  return (
    personas[currentPersona.id] ||
    "The cards have chosen to speak with you today."
  );
}
...
function generateSummary() {
  const summaries = {
    ...
    river:
      "These cards flow together like a gentle river, carrying you toward emotional healing and deeper self-understanding. Allow their nurturing energy to guide you with compassion and grace.",
    phoenix:
      "The fire of transformation burns bright through this reading! Each card is a spark igniting your potential for magnificent change. Rise up and claim the powerful destiny that awaits you!",
  };

  return (
    summaries[currentPersona.id] ||
    "Your reading reveals important guidance for your journey ahead."
  );
}
...
function submitFeedback(rating) {
  ...
  setTimeout(() => {
    showTemporaryMessage(
      "Thank you for your feedback! Your input helps our personas evolve and improve.",
    );
  }, 500);
}
...
function updatePersonaStats() {
  ...
  const personaCard = document.querySelector(
...
function viewHistory() {
  if (readingHistory.length === 0) {
    showTemporaryMessage(
      "No reading history found. Complete a reading to build your history!",
    );
    return;
  }
