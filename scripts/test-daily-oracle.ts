...
async function testDailyOracle() {
  ...
  try {
    ...
    if (data.success && data.data) {
      ...
      console.log(
        `Generated from Birth Chart: ${oracle.generatedFromBirthChart ? "Yes" : "No"}`,
      );
      ...
      console.log("============");
      console.log(
        `Sign: ${oracle.horoscope.sign} (${oracle.horoscope.degrees}°)`,
      );
      console.log(
        `Element: ${oracle.horoscope.element} | Quality: ${oracle.horoscope.quality}`,
      );
      ...
      console.log();
      console.log(
        `🌅 MORNING (${oracle.dailySpread.cards.morning.card.position}):`,
      );
      console.log(
        `   Card: ${oracle.dailySpread.cards.morning.card.name} ${oracle.dailySpread.cards.morning.card.isReversed ? "(Reversed)" : ""}`,
      );
      console.log(
        `   Keywords: ${oracle.dailySpread.cards.morning.card.keywords?.join(", ")}`,
      );
      console.log(
        `   Personal Message: ${oracle.dailySpread.cards.morning.personalizedMessage}`,
      );
      console.log();
      console.log(
        `🌞 AFTERNOON (${oracle.dailySpread.cards.afternoon.card.position}):`,
      );
      console.log(
        `   Card: ${oracle.dailySpread.cards.afternoon.card.name} ${oracle.dailySpread.cards.afternoon.card.isReversed ? "(Reversed)" : ""}`,
      );
      console.log(
        `   Keywords: ${oracle.dailySpread.cards.afternoon.card.keywords?.join(", ")}`,
      );
      console.log(
        `   Personal Message: ${oracle.dailySpread.cards.afternoon.personalizedMessage}`,
      );
      console.log();
      console.log(
        `🌙 EVENING (${oracle.dailySpread.cards.evening.card.position}):`,
      );
      console.log(
        `   Card: ${oracle.dailySpread.cards.evening.card.name} ${oracle.dailySpread.cards.evening.card.isReversed ? "(Reversed)" : ""}`,
      );
      console.log(
        `   Keywords: ${oracle.dailySpread.cards.evening.card.keywords?.join(", ")}`,
      );
      console.log(
        `   Personal Message: ${oracle.dailySpread.cards.evening.personalizedMessage}`,
      );
      console.log();
      ...
      console.log("===============");
      console.log(
        `Moon Phase: ${oracle.cosmicFocus.moonPhase} in ${oracle.cosmicFocus.moonSign}`,
      );
      ...
      console.log(
        `Relationship Advice: ${oracle.compatibility.relationshipAdvice}`,
      );
      console.log(
        `Communication Tips: ${oracle.compatibility.communicationTips}\n`,
      );
      ...
      if (oracle.isUnavailable) {
        console.log(
          "⚠️  Note: Some services were unavailable during generation",
        );
