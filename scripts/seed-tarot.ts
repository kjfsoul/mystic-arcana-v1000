...
const COMPLETE_RIDER_WAITE_DECK = [
  ...
  },
  {
    ...
    meaning_reversed: 'Independence, alone time, hardcore partying, three\'s a crowd',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'cups',
    meaning_upright: 'Creative opportunities, intuitive messages, curiosity, possibility',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'cups',
    meaning_upright: 'Compassionate, caring, emotionally stable, intuitive, in flow',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'cups',
    meaning_upright: 'Emotionally balanced, compassionate, generous, diplomatic',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'pentacles',
    meaning_upright: 'Multiple priorities, time management, prioritization, adaptability',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'pentacles',
    meaning_upright: 'Sustainable results, long-term view, perseverance, investment',
  ...
  },
  {
    ...
    meaning_reversed: 'Financial failure, lack of ambition, bribery, corruption',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'swords',
    meaning_upright: 'Betrayal, deception, getting away with something, acting strategically',
  ...
  },
  {
    ...
    meaning_reversed: 'Overly emotional, easily influenced, bitchy, cold-hearted',
  ...
  },
  {
    ...
    arcana_type: 'minor',
    suit: 'wands',
    meaning_upright: 'Resilience, courage, persistence, test of faith, boundaries',
    meaning_reversed: 'Inner resources, struggle, overwhelm, defensive, paranoia',
...
async function seedTarotCards() {
  ...
  try {
    ...
    const { error: deleteError } = await supabase
      .from('cards')
      .delete()
      .neq('id', 'never-matches'); // This deletes all cards
...
export { seedTarotCards, COMPLETE_RIDER_WAITE_DECK };