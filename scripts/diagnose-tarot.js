...
async function testAPI() {
  try {
    ...
    console.log(
      `   📈 Stats: ${data.stats.majorArcana} Major + ${data.stats.minorArcana} Minor`,
    );
...
function provideSolutions(apiWorking) {
  ...
  if (apiWorking) {
    ...
    console.log(
      '   🎯 The tarot "draw cards" functionality should work correctly.',
    );
    console.log(
      "   💡 If you're still having issues, try refreshing the page.",
    );
  } else {
