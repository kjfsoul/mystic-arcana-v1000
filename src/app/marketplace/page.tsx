...
export default function MarketplacePage() {
  ...
  const allProducts: Product[] = Object.entries(MYSTIC_PRODUCTS).map(
    ([key, product]) => ({
  ...
  const filteredProducts = useMemo(() => {
    const filtered = allProducts.filter((product) => {
      ...
      if (filters.moonPhases.length > 0) {
        if (
          !product.metadata.moon_phase ||
          !filters.moonPhases.includes(product.metadata.moon_phase)
        )
          return false;
      }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              >
                <option value="featured" className="bg-purple-900">
                  Featured
                </option>
                <option value="price_low" className="bg-purple-900">
                  Price: Low to High
                </option>
                <option value="price_high" className="bg-purple-900">
                  Price: High to Low
                </option>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {/* Celestial Events */}
                  {product.metadata.cosmic_alignment
                    ?.slice(0, 2)
                    .map((event) => (
                      <span
                        key={event}
