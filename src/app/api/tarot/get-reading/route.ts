...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!user) {
      logger.warn('tarot_get_reading_unauthenticated', undefined, undefined, 'Attempted to get reading without authentication.');
 ...
 */
function formatReading(rawReading: any) {
