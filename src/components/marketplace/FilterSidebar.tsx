    ...
    <>
      ...
      >
        <div className={styles.sidebarHeader}>
          <h2 className={styles.sidebarTitle}>✨ Cosmic Filters</h2>
          <button
        ...
        <div className={styles.sidebarContent}>
          ...
          <FilterSection title="🛍️ Product Types" sectionKey="productTypes">
            <CheckboxFilter
              ...
              onToggle={(value) =>
                toggleArrayFilter(filters.productTypes, value, "productTypes")
              }
            />
          </FilterSection>
          <FilterSection title="🌈 Elements" sectionKey="elements">
            <CheckboxFilter
              ...
              onToggle={(value) =>
                toggleArrayFilter(filters.elements, value, "elements")
              }
            />
          </FilterSection>
          <FilterSection title="🌙 Moon Phases" sectionKey="moonPhases">
            <CheckboxFilter
              ...
              onToggle={(value) =>
                toggleArrayFilter(filters.moonPhases, value, "moonPhases")
              }
            />
          </FilterSection>
          ...
          <FilterSection title="⭐ Special" sectionKey="special">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  updateFilter("showLimitedEdition", e.target.checked)
                }
                className={styles.hiddenCheckbox}
              />
