...
const ResponsiveTarotRoom: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`w-full bg-black/70 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl ${
            isMobile ? "p-4" : "p-12"
          }`}
        >
          <UnifiedTarotPanel />
    ...
    >
      ...
      >
        <AnimatePresence mode="wait">
          ...
          >
            <h1
              className={`font-extralight tracking-wider drop-shadow-[0_4px_30px_rgba(0,0,0,0.7)] ${
            ...
            <p
              className={`text-white/70 ${isMobile ? "text-base" : "text-xl"}`}
            >
          ...
          {isTransitioning && (
            ...
            >
              <div className="text-center text-white">
                ...
                <p
                  className={`opacity-80 ${isMobile ? "text-base" : "text-xl"}`}
                >
      ...
      {!isMobile && (
        ...
        >
          <div className="bg-black/80 backdrop-blur-2xl border border-amber-500/30 rounded-2xl p-6 max-w-xs text-center text-white">
            <h3 className="text-lg mb-2 text-amber-400 font-semibold">
              ✨ Cosmic Reading Bundle
            </h3>
            <p className="text-base mb-4 opacity-80 leading-relaxed">
