        ...
        <div className={styles.formRow}>
          ...
          <div className={styles.formField}>
            ...
            <select
              ...
              onChange={(e) => setNewEvent({ ...newEvent, month: e.target.value ? parseInt(e.target.value) : undefined })}
            >
        ...
        <div className={styles.formRow}>
          ...
          <div className={styles.formField}>
            ...
            <select
              ...
              onChange={(e) => setNewEvent({ ...newEvent, significance: e.target.value as LifeEvent['significance'] })}
            >
    ...
    <div className={`${styles.container} ${className || ''}`}>
      <div className={styles.header}>
        <div className={styles.titleSection}>
          ...
          <p className={styles.subtitle}>
            Map the key moments and transformative events that shaped who you are today
          </p>
        </div>
        <button
      ...
      {sortedEvents.length === 0 && !showAddForm && (
        ...
        >
          ...
          <p>Start mapping your life journey by adding significant events and milestones.</p>
          <button
        ...
        <div className={styles.timeline}>
          ...
          {sortedEvents.map((event, index) => (
            ...
            >
              ...
              />
              <div className={`${styles.eventCard} ${index % 2 === 0 ? styles.left : styles.right}`}>
                <div className={styles.eventHeader}>
                  <div className={styles.eventDate}>
                    {event.month ? `${new Date(2000, event.month - 1).toLocaleDateString('en-US', { month: 'short' })} ` : ''}
                    {event.year}
                  </div>
                ...
                <div className={styles.eventMeta}>
                  ...
                  >
                    {SIGNIFICANCE_LEVELS.find(level => level.value === event.significance)?.label}
                  </span>
                </div>
                {event.description && (
      ...
      {sortedEvents.length > 0 && (
        <div className={styles.timelineInsights}>
          ...
          <div className={styles.insights}>
            ...
            <div className={styles.insight}>
              <span className={styles.insightLabel}>Life-Changing Moments:</span>
              <span className={styles.insightValue}>
                {sortedEvents.filter(e => e.significance === 'transformative').length}
              </span>
            </div>
            <div className={styles.insight}>
          ...
          <p className={styles.insightNote}>
            Your timeline will help reveal patterns and themes for deeper astrological analysis in the Advanced Chart.
          </p>
        </div>
      )}
    </div>
