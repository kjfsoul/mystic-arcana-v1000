...
const PERSONALITY_QUESTIONS: PersonalityTest[] = [
  {
    ...
    answers: [
      ...
      {
        text: "Solving complex problems independently",
        weight: 1,
        category: "analytical",
      },
      {
        text: "Creating and innovating new solutions",
        weight: 1,
        category: "creative",
      },
      {
  ...
  },
  {
    ...
    answers: [
      {
        text: "Take charge and mobilize resources quickly",
        weight: 1,
        category: "leadership",
      },
      {
      ...
      {
        text: "Collaborate and seek input from others",
        weight: 1,
        category: "social",
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: "Dynamic, fast-paced with clear hierarchy",
        weight: 1,
        category: "leadership",
      },
      {
        text: "Quiet, organized with access to information",
        weight: 1,
        category: "analytical",
      },
      {
        text: "Flexible, inspiring with room for experimentation",
        weight: 1,
        category: "creative",
      },
      {
        text: "Collaborative, supportive with team interaction",
        weight: 1,
        category: "social",
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: "Achieving positions of influence and authority",
        weight: 1,
        category: "leadership",
      },
      {
        text: "Mastering expertise and being recognized for knowledge",
        weight: 1,
        category: "analytical",
      },
      {
        text: "Expressing originality and leaving a creative mark",
        weight: 1,
        category: "creative",
      },
      {
...
export const InteractiveCareerInsights: React.FC<
  InteractiveCareerInsightsProps
> = ({ birthData, onBack }) => {
  const [careerAnalysis, setCareerAnalysis] = useState<CareerAnalysis | null>(
    null,
  );
  ...
  const [selectedTab, setSelectedTab] = useState<
    "overview" | "strengths" | "challenges" | "paths"
  >("overview");
  ...
  const getPersonalityInsight = () => {
    ...
    const dominantType = Object.entries(personalityScores).find(
      ([, score]) => score === maxScore,
    )?.[0];
    const insights = {
      leadership:
        "Your astrological profile combined with your responses suggests strong leadership potential. You're drawn to positions where you can guide and influence others.",
      analytical:
        "Your cosmic blueprint aligns with analytical thinking. You excel at processing complex information and finding logical solutions.",
      creative:
        "Your birth chart resonates with creative expression. You're naturally inclined toward innovative and artistic pursuits.",
      social:
        "Your planetary influences emphasize interpersonal connections. You thrive in collaborative environments and helping others.",
    };
      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-400">
            Analyzing your cosmic career blueprint...
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="text-center py-8">
        <p className="text-red-400">
          Unable to load career analysis. Please try again.
        </p>
      </div>
    );
  }
              ...
              >
                ...
                >
                  ...
                  <div className="mb-6">
                    <div className="w-full bg-gray-700 rounded-full h-2 mb-4">
                      <div
                        ...
                        style={{
                          width: `${((currentQuestion + 1) / PERSONALITY_QUESTIONS.length) * 100}%`,
                        }}
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    {PERSONALITY_QUESTIONS[currentQuestion].answers.map(
                      (answer, index) => (
                        <motion.button
                          key={index}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-800/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        {Object.entries(careerAnalysis.keyPlacements).map(
                          ([key, value]) => (
                            <div key={key}>
                    ...
                    {testCompleted && (
                      <div className="bg-gray-800/50 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          {Object.entries(personalityScores).map(
                            ([type, score]) => (
                  ...
                  {careerAnalysis.challenges.map((challenge, index) => (
                    ...
                    >
                      ...
                      <div className="bg-gray-800/50 rounded p-3">
                        <h5 className="text-purple-400 text-xs font-medium mb-1">
                          Advice:
                        </h5>
