  ...
  useEffect(() => {
    async function fetchBirthChart() {
      try {
        ...
        setError(
          err instanceof Error ? err.message : "Failed to load birth chart",
        );
        const fallback = getFallbackChart();
        setChartData(fallback);
        setIsUnavailable(true);
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {isUnavailable && (
          ...
          >
            ...
            <p className="text-yellow-100 mb-4">
              ...
              astrological insights based on real planetary positions.
            </p>
            <button
              onClick={handleRetry}
        ...
        {!isUnavailable && (
          ...
          >
            <p>
              ✨ Chart generated using authentic astronomical calculations with
