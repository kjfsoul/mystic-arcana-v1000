...
export const LocationSearch: React.FC<LocationSearchProps> = ({
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setSearchError(
        "Unable to find location. Please check your spelling or try a different search.",
      );
      onChange(null);
    } finally {
      setIsLoading(false);
      ...
      <div className={styles.inputContainer}>
        ...
        <AnimatePresence>
          {showSuggestions && suggestions.length > 0 && (
            ...
            >
              {query.length === 0 && (
                <div className={styles.suggestionHeader}>Popular Locations</div>
              )}
              ...
              {suggestions.map((location, index) => (
                ...
                >
                  ...
                  <div className={styles.suggestionContent}>
                    <div className={styles.suggestionName}>{location.name}</div>
                    {location.timezone && (
      ...
      {value && (
        ...
        >
          ...
          <div className={styles.selectedContent}>
            ...
            <div className={styles.selectedCoords}></div>
          </div>
        </motion.div>
      )}
    </div>
