...
export const ReaderPanel: React.FC<ReaderPanelProps> = ({ className = "" }) => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "reader",
      content:
        "Welcome, seeker. I sense you have questions about your path. How may the cards guide you today?",
      timestamp: new Date(),
      readerMood: "mystical",
    },
  ]);
  ...
  const [readerMood, setReaderMood] = useState<
    "mystical" | "contemplative" | "encouraging" | "neutral"
  >("mystical");
  ...
  const currentReader =
    virtualReaders.find((r) => r.id === selectedReader) || virtualReaders[0];
    ...
    setTimeout(
      () => {
        const responses = [
          {
            content:
              "The cards whisper of transformation ahead. Trust in your inner wisdom as you navigate this change.",
            mood: "mystical" as const,
          },
          {
            content:
              "I see strength within you that you may not yet recognize. This challenge is preparing you for something greater.",
          ...
          {
            content:
              "Your intuition is trying to communicate something important. Take time for quiet reflection today.",
            mood: "contemplative" as const,
          },
          {
            content:
              "The energy around you suggests new opportunities emerging. Be open to unexpected possibilities.",
            mood: "encouraging" as const,
          },
        ];
  ...
  return (
    <div className={`${styles.container} ${className}`}>
            ...
            {virtualReaders.map((reader) => (
              ...
              >
                ...
                <div className={styles.readerInfo}>
                  ...
                  <p className={styles.readerPersonality}>
                    {reader.personality}
                  </p>
                  <p
                    id={`reader-${reader.id}-desc`}
                    className={styles.readerSpecialty}
                  >
                    {reader.specialty}
                  </p>
                </div>
      ...
      <section
        className={styles.activeReader}
        aria-label="Current reader information"
      >
        <div className={styles.currentReaderCard}>
          <div className={styles.currentAvatar}>
            <span className={styles.currentAvatarIcon}>
          ...
          <div className={styles.currentReaderInfo}>
            ...
            <p className={styles.currentReaderDesc}>
          ...
          {messages.map((message) => (
            ...
            >
              ...
              <div className={styles.messageContent}>
                <div
                  className={`${styles.messageText} ${message.readerMood ? styles[message.readerMood] : ""}`}
                >
                  {message.content}
                </div>
