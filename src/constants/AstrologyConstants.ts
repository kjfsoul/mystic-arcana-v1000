...
export const Planets = ['Sun', 'Moon', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Chiron', 'North Node', 'South Node'] as const;
export type Planet = typeof Planets[number];

export const ZodiacSigns = ['Aries', 'Taurus', 'Gemini', 'Cancer', 'Leo', 'Virgo', 'Libra', 'Scorpio', 'Sagittarius', 'Capricorn', 'Aquarius', 'Pisces'] as const;
export type ZodiacSign = typeof ZodiacSigns[number];

export const AspectTypes = ['Conjunction', 'Opposition', 'Trine', 'Square', 'Sextile', 'Quincunx', 'Semisextile', 'Semisquare', 'Sesquiquadrate'] as const;
