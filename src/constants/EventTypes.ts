...
export const ReadingRequestTypes = [
  "birth_chart",
  "transit",
  "tarot_spread",
  "mixed",
...
export const PersonaInsightSources = [
  "reading-response",
  "behavior",
  "preference",
] as const;
...
export const InteractionSessionReadingTypes = [
  "tarot",
  "astrology",
  "mixed",
] as const;
export type InteractionSessionReadingType =
  (typeof InteractionSessionReadingTypes)[number];

export const MemoryLogNamespaces = [
  "user-interaction",
  "persona-learning",
  "reading-context",
] as const;
...
export const CosmicIntensities = [
  "calm",
  "active",
  "intense",
  "transformative",
...
export const CosmicWeatherTypes = [
  "calm",
  "active",
  "turbulent",
  "transformative",
