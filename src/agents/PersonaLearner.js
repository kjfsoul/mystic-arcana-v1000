...
var PersonaLearnerAgent = /** @class */ (function () {
     ...
     */
    PersonaLearnerAgent.prototype.logInteraction = function (userId, session, userFeedback) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        learningEvent = {
                            ...
                            data: {
                                ...
                                cards: session.cards.map(function (c) { return c.name; }),
                            ...
                            context: {
                                spread_type: session.spreadType,
                                cards_drawn: session.cards.map(function (c) { return c.name; }),
                                interpretation_quality: 0, // No quality in ConversationSession
                                user_satisfaction: (userFeedback === null || userFeedback === void 0 ? void 0 : userFeedback.rating) || undefined
                            }
                        };
                    ...
                    case 4:
                        // Process learning patterns
                        _a.sent();
                        console.log("PersonaLearner: Logged interaction for user ".concat(userId, ", reading ").concat(reading.id));
                        return [3 /*break*/, 6];
                    case 5:
                        error_1 = _a.sent();
                        console.error('PersonaLearner: Failed to log interaction:', error_1);
                        throw error_1;
     ...
     */
    PersonaLearnerAgent.prototype.createMemoryNote = function (reading, userFeedback) {
        return __awaiter(this, void 0, void 0, function () {
            var cardNames, spreadType, themes, keywords, memoryNote;
            var _a;
            return __generator(this, function (_b) {
                cardNames = ((_a = reading.session_context.cards) === null || _a === void 0 ? void 0 : _a.map(function (c) { return c.name; })) || [];
                spreadType = reading.session_context.spreadType;
                themes = this.extractThemes(reading.narrative + ' ' + reading.overall_guidance);
                keywords = __spreadArray(__spreadArray(__spreadArray(__spreadArray([], cardNames.map(function (name) { return name.toLowerCase().replace(/\s+/g, '_'); }), true), [
                ...
                memoryNote = {
                    content: JSON.stringify({
                        ...
                        learning_insights: {
                            ...
                            interpretation_quality: 0, // No quality in ConversationSession
                            personalization_applied: reading.card_interpretations.some(function (interp) {
                                return interp.confidence_score > 0.8;
                            })
                        }
                    }),
                    keywords: keywords,
                    context: "Tarot reading session with Sophia for ".concat(spreadType, " spread"),
                    ...
                    tags: __spreadArray([
                        ...
                        'sophia_session',
                        "spread_".concat(spreadType)
                    ], cardNames.slice(0, 3).map(function (name) { return "card_".concat(name.toLowerCase().replace(/\s+/g, '_')); }), true),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.post("".concat(this.supermemoryMcpUrl, "/record"), payload)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 201) {
                            ...
                            throw new Error("Supermemory MCP logging failed with status: ".concat(response.status));
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
                        console.error('PersonaLearner: Supermemory MCP logging failed:', error_2);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                if (event.eventType === 'reading_completed') {
                    ...
                    if ((_b = event.data.feedback) === null || _b === void 0 ? void 0 : _b.helpful_cards) {
                        for (_i = 0, _a = event.data.feedback.helpful_cards; _i < _a.length; _i++) {
                            card = _a[_i];
    ...
    PersonaLearnerAgent.prototype.processLearningPatterns = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var profile, recentEvents, spreadPreferences, cardAffinities, engagementPatterns;
            return __generator(this, function (_a) {
                profile = this.userProfiles.get(userId);
                if (!profile)
                    return [2 /*return*/];
                recentEvents = this.learningQueue.filter(function (event) { return event.userId === userId &&
     ...
     */
    PersonaLearnerAgent.prototype.getPersonalizationRecommendations = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                engagementLevel = profile.learning_patterns.engagement_score > 0.7 ? 'high' :
    ...
    PersonaLearnerAgent.prototype.generateCardCombinations = function (cardNames) {
        var combinations = [];
    ...
    PersonaLearnerAgent.prototype.calculateReadingQuality = function (reading) {
        ...
        if (reading.narrative.length > 500)
            quality += 0.2;
        // Multiple interpretations show thoroughness
        if (reading.card_interpretations.length > 2)
            quality += 0.1;
        // High confidence interpretations indicate good data
        var avgConfidence = reading.card_interpretations.reduce(function (sum, interp) { return sum + interp.confidence_score; }, 0) / reading.card_interpretations.length;
    ...
    PersonaLearnerAgent.prototype.analyzeEngagementPatterns = function (events) {
        var satisfactionScores = events
            .map(function (e) { return e.context.user_satisfaction; })
            .filter(function (score) { return score !== undefined; });
        var averageSatisfaction = satisfactionScores.length > 0
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, undefined, 3]);
                        console.log("PersonaLearner: Retrieving memories for user ".concat(userId, " from Supermemory MCP"));
                        return [4 /*yield*/, axios_1.default.get("".concat(this.supermemoryMcpUrl, "/journey/").concat(userId))];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            journeyEntries = response.data.journey;
                            console.log("PersonaLearner: Retrieved ".concat(journeyEntries.length, " memories for user ").concat(userId, " from Supermemory MCP"));
                            // Map journey entries to MemoryNote format
                            return [2 /*return*/, journeyEntries.map(function (entry) { return ({
                            ...
                            throw new Error("Supermemory MCP retrieval failed with status: ".concat(response.status));
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
                        console.error('PersonaLearner: Failed to retrieve user memories from Supermemory MCP:', error_3);
                        return [2 /*return*/, []];
                    case 3: return [2 /*return*/];
                }
            });
     ...
     */
    PersonaLearnerAgent.prototype.checkAndIncrementEngagementLevel = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var currentLevel, userMemories, engagementMetrics, newLevel, updated, thresholdName, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!userId) {
                            console.log('PersonaLearner: Skipping engagement level check for guest user');
                            return [2 /*return*/, { levelIncreased: false, newLevel: 1, previousLevel: 1 }];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 6, undefined, 7]);
                        console.log("PersonaLearner: Checking engagement level for user ".concat(userId));
                    ...
                    case 3:
                        ...
                        newLevel = this.calculateNewEngagementLevel(engagementMetrics, currentLevel);
                    ...
                    case 4:
                        ...
                        if (updated) {
                            ...
                            console.log("PersonaLearner: User ".concat(userId, " leveled up from ").concat(currentLevel, " to ").concat(newLevel, " (").concat(thresholdName, ")"));
                            return [2 /*return*/, {
                                    levelIncreased: true,
                                    newLevel: newLevel,
                    ...
                    case 6:
                        error_4 = _a.sent();
                        console.error('PersonaLearner: Failed to check engagement level:', error_4);
                        return [2 /*return*/, { levelIncreased: false, newLevel: 1, previousLevel: 1 }];
    ...
    PersonaLearnerAgent.prototype.getCurrentEngagementLevel = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    storedLevel = localStorage === null || localStorage === void 0 ? void 0 : localStorage.getItem("engagementLevel_".concat(userId));
     ...
     */
    PersonaLearnerAgent.prototype.analyzeEngagementMetrics = function (userMemories) {
            ...
            try {
                if (memory.content && typeof memory.content === 'string') {
                    ...
                    if (memoryData.reading_summary) {
                        completedReadings++;
                        var sessionId = memoryData.reading_summary.session_id || ((_a = memoryData.interaction_data) === null || _a === void 0 ? void 0 : _a.session_id);
                        if (sessionId)
        ...
        var avgEngagement = engagementCount > 0 ? totalEngagement / engagementCount : 0;
     ...
     */
    PersonaLearnerAgent.prototype.calculateNewEngagementLevel = function (metrics, currentLevel) {
        ...
        for (var _i = 0, thresholds_1 = thresholds; _i < thresholds_1.length; _i++) {
            ...
            var criteriaCount = [meetsReadings, meetsTurns, meetsQuestions].filter(Boolean).length;
            var exceptionalReadings = metrics.completedReadings >= threshold.readings * 1.5;
     ...
     */
    PersonaLearnerAgent.prototype.updateEngagementLevel = function (userId, newLevel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    // For testing, store in localStorage
                    if (typeof localStorage !== 'undefined') {
                        localStorage.setItem("engagementLevel_".concat(userId), newLevel.toString());
                    }
                    ...
                    //   new_level: newLevel
                    // });
                    console.log("PersonaLearner: Updated engagement level for user ".concat(userId, " to ").concat(newLevel));
    ...
    PersonaLearnerAgent.prototype.getEngagementAnalysis = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var currentLevel_1, userMemories, metrics, thresholds, nextThreshold, progressToNext, readingProgress, turnProgress, questionProgress, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!userId) {
                    ...
                    case 3:
                        ...
                        nextThreshold = thresholds.find(function (t) { return t.level > currentLevel_1; });
                        progressToNext = 0;
                        if (nextThreshold) {
                            readingProgress = metrics.completedReadings / nextThreshold.readings;
                            turnProgress = metrics.conversationTurns / nextThreshold.turns;
                            questionProgress = metrics.questionsAnswered / nextThreshold.questions;
                    ...
                    case 4:
                        error_5 = _a.sent();
                        console.error('PersonaLearner: Failed to get engagement analysis:', error_5);
                        return [2 /*return*/, {
                                currentLevel: 1,
    ...
    PersonaLearnerAgent.prototype.getStats = function () {
        var lastActivity = this.learningQueue.length > 0
            ? this.learningQueue[this.learningQueue.length - 1].timestamp
            : null;
        var interactionEvents = this.learningQueue.filter(function (e) {
            return ['conversation_turn', 'user_response', 'card_revealed', 'question_answered'].includes(e.eventType);
        }).length;
        var conversationTurns = this.learningQueue.filter(function (e) { return e.eventType === 'conversation_turn'; }).length;
        return {
     ...
     */
    PersonaLearnerAgent.prototype.logConversationTurn = function (userId, sessionId, conversationState, turnNumber, sophiaDialogue, userResponse, revealedCard) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!userId)
                            return [2 /*return*/]; // Skip for guest users
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, undefined, 5]);
                        learningEvent = {
                        ...
                        this.learningQueue.push(learningEvent);
                        return [4 /*yield*/, this.createConversationMemoryNote(learningEvent)];
                    case 2:
                        memoryNote = _a.sent();
                        return [4 /*yield*/, this.logToAMem(memoryNote)];
                    case 3:
                        _a.sent();
                        console.log("PersonaLearner: Logged conversation turn ".concat(turnNumber, " for user ").concat(userId));
                        return [3 /*break*/, 5];
                    case 4:
                        error_6 = _a.sent();
                        console.error('PersonaLearner: Failed to log conversation turn:', error_6);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
     ...
     */
    PersonaLearnerAgent.prototype.logUserResponse = function (userId, sessionId, responseText, responseContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateResponsePatterns(userId, learningEvent)];
                    case 2:
                        // Update user profile with response patterns
                        _a.sent();
                        console.log("PersonaLearner: Logged user response for user ".concat(userId));
                        return [3 /*break*/, 4];
                    case 3:
                        error_7 = _a.sent();
                        console.error('PersonaLearner: Failed to log user response:', error_7);
                        return [3 /*break*/, 4];
     ...
     */
    PersonaLearnerAgent.prototype.logCardReveal = function (userId, sessionId, cardName, cardIndex, engagementMetrics) {
        return __awaiter(this, void 0, void 0, function () {
            var learningEvent;
            return __generator(this, function (_a) {
                if (!userId)
                ...
                try {
                    ...
                    this.learningQueue.push(learningEvent);
                    console.log("PersonaLearner: Logged card reveal for ".concat(cardName));
                }
                catch (error) {
     ...
     */
    PersonaLearnerAgent.prototype.logQuestionResponse = function (userId, sessionId, question, response, questionContext) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.learningQueue.push(learningEvent);
                        if (!learningEvent.data.provides_new_insight) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        console.log("PersonaLearner: Logged question response for user ".concat(userId));
                        return [3 /*break*/, 6];
                    case 5:
                        error_8 = _a.sent();
                        console.error('PersonaLearner: Failed to log question response:', error_8);
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/];
                }
            });
     ...
     */
    PersonaLearnerAgent.prototype.createConversationMemoryNote = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        content: JSON.stringify({
                        ...
                        keywords: [
                            ...
                            event.data.revealed_card ? "card_".concat(event.data.revealed_card.card.name.toLowerCase().replace(/\s+/g, '_')) : '',
                            'sophia_interaction'
                        ].filter(Boolean),
                        context: "Conversation turn ".concat(event.data.turn_number, " in state ").concat(event.data.conversation_state),
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        ...
                        keywords: [
                            ...
                            event.data.related_card ? "card_".concat(event.data.related_card.toLowerCase().replace(/\s+/g, '_')) : '',
                            'user_insight'
                        ].filter(Boolean),
                        context: "Interactive question of type ".concat(event.data.question_type),
    ...
    PersonaLearnerAgent.prototype.analyzeResponseStyle = function (response) {
        ...
        var emotionalWords = ['feel', 'heart', 'soul', 'love', 'fear', 'hope', 'dream'];
        var analyticalWords = ['think', 'analyze', 'consider', 'logic', 'reason', 'because'];
        var hasEmotionalWords = emotionalWords.some(function (word) { return response.toLowerCase().includes(word); });
        var hasAnalyticalWords = analyticalWords.some(function (word) { return response.toLowerCase().includes(word); });
        if (length < 50)
            return 'concise';
        if (hasEmotionalWords)
            return 'emotional';
        if (hasAnalyticalWords)
            return 'analytical';
        return 'detailed';
    };
    PersonaLearnerAgent.prototype.analyzeResponseSentiment = function (response) {
        var positiveWords = ['good', 'great', 'love', 'happy', 'excited', 'wonderful', 'amazing'];
        var negativeWords = ['bad', 'hate', 'sad', 'worried', 'terrible', 'awful', 'frustrated'];
        var positiveCount = positiveWords.filter(function (word) { return response.toLowerCase().includes(word); }).length;
        var negativeCount = negativeWords.filter(function (word) { return response.toLowerCase().includes(word); }).length;
    ...
    PersonaLearnerAgent.prototype.calculateEngagementLevel = function (metrics) {
        ...
        if (metrics.clicked)
            score += 2;
        if (metrics.interpretation_read)
            score += 3;
        if (metrics.hover_time_ms && metrics.hover_time_ms > 2000)
            score += 1;
        if (score >= 4)
            return 'high';
        if (score >= 2)
    ...
    PersonaLearnerAgent.prototype.assessInsightValue = function (response) {
        ...
        return response.length > 100 && (response.toLowerCase().includes('i ') ||
            response.toLowerCase().includes('my ') ||
            response.toLowerCase().includes('me '));
    };
    PersonaLearnerAgent.prototype.updateResponsePatterns = function (userId, event) {
        return __awaiter(this, void 0, void 0, function () {
