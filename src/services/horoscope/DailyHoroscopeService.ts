...
export class DailyHoroscopeService {
  ...
  getGeneralDailyHoroscope(): DailyHoroscope {
    ...
    const generalHoroscopes = [
      {
        overview:
          "Today's cosmic energy encourages introspection and spiritual growth. The universe is aligning to bring clarity to your deepest questions.",
      ...
      {
        overview:
          "A day of transformation awaits. The stars suggest embracing change and trusting your intuition as new opportunities emerge.",
      ...
      {
        overview:
          "Celestial harmony brings balance to your endeavors. Focus on relationships and creative pursuits for maximum cosmic support.",
        energy: "high" as const,
        mood: "harmonious",
      ...
      {
        overview:
          "The mystic veil is thin today. Pay attention to synchronicities and dreams as the universe sends important messages.",
        energy: "medium" as const,
        mood: "mysterious",
      ...
      {
        overview:
          "Grounding energy prevails. Take practical steps toward your goals while maintaining connection to your spiritual essence.",
        energy: "low" as const,
        mood: "grounded",
  ...
  private generatePersonalizedAdvice(sign: ZodiacSign): string {
    const advice = {
      aries:
        "Channel your natural leadership today. Take initiative in projects that matter to you.",
      taurus:
        "Focus on building lasting foundations. Your patience will yield beautiful results.",
      gemini:
        "Communicate your ideas clearly. Network and share knowledge with others.",
      cancer:
        "Trust your emotional intelligence. Nurture yourself and your relationships.",
      leo: "Let your creativity shine. Express yourself authentically and inspire others.",
      virgo:
        "Pay attention to details. Your analytical nature reveals important insights.",
      libra: "Seek balance in all areas. Harmony and diplomacy open new doors.",
      scorpio:
        "Embrace transformation. Your intensity creates powerful positive change.",
      sagittarius:
        "Explore new horizons. Your optimism attracts exciting opportunities.",
      capricorn:
        "Stay disciplined and focused. Your determination builds lasting success.",
      aquarius:
        "Think outside the box. Your innovative ideas lead to breakthroughs.",
      pisces:
        "Listen to your intuition. Your compassion creates meaningful connections.",
    };
    return advice[sign] || advice.aries;
  }
  private generateFocusArea(zodiacSign: {
    element: string;
    rulingPlanet: string;
  }): string {
    const elementFocus = {
    ...
    const element =
      elementFocus[zodiacSign.element as keyof typeof elementFocus] ||
      "balance";
    const planet =
      planetFocus[zodiacSign.rulingPlanet as keyof typeof planetFocus] ||
      "growth";
