...
function createClient() {
    return __awaiter(this, void 0, void 0, function () {
        var cookieStore, supabaseUrl, supabaseAnonKey;
...
function createAdminClient() {
    ...
    if (!supabaseUrl || !supabaseServiceKey) {
        ...
        throw new Error('Missing Supabase admin environment variables. Please check NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY in your .env.local file.');
    }
    return (0, ssr_1.createServerClient)(supabaseUrl, supabaseServiceKey, {
        cookies: {
