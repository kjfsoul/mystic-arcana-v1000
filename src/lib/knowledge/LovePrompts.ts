...
export const LOVE_PROMPTS: LovePrompt[] = [
  // LOVE STYLE PROMPTS
  {
    ...
    prompt:
      "Your Aries Venus loves with fire and courage, dear one. You are drawn to the thrill of new connection and the excitement of pursuit. How does this bold energy feel in your heart right now? Are you honoring your need for passionate, direct love?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your Taurus Venus seeks love that feels like coming home - steady, sensual, and deeply rooted. You treasure loyalty and the slow, sweet unfolding of affection. What does emotional security look like in your heart's vision? How do you nurture the garden of love?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your Gemini Venus delights in the dance of minds and the music of conversation. You fall in love with wit, curiosity, and the endless variety that connection can offer. How does your heart seek mental stimulation in relationships? What conversations make your soul sparkle?",
    followUp: [
  ...
  // EMOTIONAL NEEDS PROMPTS
  {
    ...
    prompt:
      "Your Cancer Moon holds an ocean of feeling, sweet soul. You need love that feels like the safest harbor - protective, nurturing, and unconditionally accepting. How do you honor your deep sensitivity as a gift rather than a burden? What would make your heart feel most held?",
    followUp: [
  ...
  },
  {
    ...
    trigger: "Moon in Leo",
    prompt:
      "Your Leo Moon needs love that sees and celebrates the magnificent light within you. You flourish when appreciated, admired, and encouraged to shine your brightest. How do you ask for the recognition your heart craves? What makes you feel most radiant in love?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your Scorpio Moon seeks love that dares to dive into the depths, beloved. Surface connections cannot satisfy your soul - you need intimacy that transforms, passion that heals, and trust that goes bone-deep. How do you honor your need for profound emotional connection?",
    followUp: [
  ...
  // COMPATIBILITY PROMPTS
  {
    ...
    prompt:
      "Your heart holds both fire and water, creating beautiful steam when balanced, or conflict when overwhelmed. The passion of fire can warm water's depths, while water can cool fire's intensity. How do you honor both the flame of desire and the ocean of feeling within you?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "You blend the wisdom of earth with the freedom of air - practicality dances with ideas, stability reaches toward inspiration. This combination offers both grounding and flight. How do you weave together your need for security with your love of mental exploration?",
    followUp: [
  ...
  // SHADOW WORK PROMPTS
  {
    ...
    prompt:
      "Your heart has learned to build walls where it once dreamed of bridges. Saturn's lessons in love can feel heavy, but they also teach the most enduring truths about worthy affection. What fears about love are ready to be witnessed with compassion rather than judgment?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your heart knows love as transformation, not just comfort. You are drawn to connections that change you, that reveal hidden depths, that ask you to surrender and be reborn. How do you embrace this intensity while maintaining your center? What does healthy intensity look like?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your emotional wounds carry the seeds of your greatest compassion. Where your heart has been broken open, light can enter - both for your own healing and for offering sanctuary to others. How are you learning to tend your tender places with the same love you give others?",
    followUp: [
  ...
  // HEALING PROMPTS
  {
    ...
    prompt:
      "The new moon whispers of fresh beginnings in your heart's garden. This is sacred time for planting seeds of love - both for yourself and in your relationships. What intentions want to grow in the fertile darkness of this lunar embrace? What love are you calling forth?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "The full moon illuminates what is ready to be released from your heart's chambers. Old griefs, outdated fears, patterns that no longer serve your highest love - all can be offered to this silver light for transformation. What are you ready to let go of with gratitude?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Venus returns to kiss the same degree where she danced at your birth, bringing gifts of renewal in love and beauty. This is your personal love new year, sweet one. What has your heart learned since her last visit? What new chapters in love are ready to unfold?",
    followUp: [
...
export class LovePromptSelector {
  static selectPromptsForChart(
    ...
    categories.forEach((category) => {
      if (!selectedPrompts.find((p) => p.category === category)) {
        const categoryPrompts = LOVE_PROMPTS.filter(
  ...
  static selectCompatibilityPrompts(
    ...
    if (
      (person1VenusElement === "fire" && person1MoonElement === "water") ||
      (person1VenusElement === "water" && person1MoonElement === "fire")
    ) {
      const fireWaterPrompt = LOVE_PROMPTS.find(
        (p) => p.id === "fire_water_balance",
      );
    ...
    if (
      (person1VenusElement === "earth" && person1MoonElement === "air") ||
      (person1VenusElement === "air" && person1MoonElement === "earth")
    ) {
      const earthAirPrompt = LOVE_PROMPTS.find(
        (p) => p.id === "earth_air_grounding",
      );
  ...
  private static getElementForSign(
    sign: string,
