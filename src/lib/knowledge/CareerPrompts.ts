...
export const CAREER_PROMPTS: CareerPrompt[] = [
  // CAREER PATH PROMPTS
  {
    ...
    prompt:
      "With your Aries Midheaven, you are called to pioneer and lead. Your professional reputation thrives when you initiate new projects and take bold action. How do you feel about embracing more leadership responsibilities in your current role?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your Taurus Midheaven suggests a career built on stability, beauty, and tangible results. You excel in roles that offer security while creating lasting value. Are you feeling fulfilled by the stability and growth potential in your current professional situation?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "With Gemini on your Midheaven, your career success flows through communication, versatility, and intellectual exchange. You thrive in roles that keep you learning and connecting with diverse people. How are you currently utilizing your natural communication gifts?",
    followUp: [
  ...
  // TIMING PROMPTS
  {
    ...
    prompt:
      "You are experiencing your Saturn return - a cosmic restructuring period that occurs roughly every 29 years. This is prime time for making foundational changes to your career path. What professional structures or commitments are you ready to either strengthen or release?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Jupiter is expanding your professional horizons right now. This is an excellent time for growth, new opportunities, and taking your career to the next level. What expansion or advancement feels most aligned with your vision?",
    followUp: [
  ...
  // PURPOSE PROMPTS
  {
    ...
    prompt:
      "With your Sun in the 10th house, your core identity is deeply connected to your professional achievements and public recognition. Your life purpose unfolds through your career. Do you feel your current work truly reflects who you are at your core?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Your Sun in the 6th house reveals a life purpose centered on service, health, and perfecting your craft. You find meaning through work that helps others and contributes to wellbeing. How does your current role allow you to serve others or improve conditions?",
    followUp: [
  ...
  // CHALLENGES PROMPTS
  {
    ...
    prompt:
      "Saturn is creating productive tension with your career direction, asking you to build more solid foundations. You may be feeling restricted or facing obstacles, but these challenges are strengthening your professional resilience. What career foundations need reinforcement right now?",
    followUp: [
  ...
  // STRENGTHS PROMPTS
  {
    ...
    prompt:
      "Jupiter is flowing harmoniously with your career energy, amplifying your natural talents and opening doors. Your optimism and wisdom are professional assets right now. How can you leverage your current confidence and opportunities for long-term career benefit?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Mars in your 10th house gives you powerful drive and ambition in your career. You have the energy to overcome obstacles and the courage to take professional risks. How are you channeling this dynamic energy in your current professional pursuits?",
    followUp: [
...
export class CareerPromptSelector {
  static selectPromptsForChart(
    ...
    const mcPrompt = CAREER_PROMPTS.find((p) =>
      p.trigger
        .toLowerCase()
        .includes(`midheaven in ${midheavenSign.toLowerCase()}`),
    );
    ...
    tenthHousePlanets.forEach((planet) => {
      const planetPrompt = CAREER_PROMPTS.find((p) =>
        p.trigger
          .toLowerCase()
          .includes(`${planet.toLowerCase()} in 10th house`),
      );
    ...
    categories.forEach((category) => {
      if (!selectedPrompts.find((p) => p.category === category)) {
        const fallbackPrompt = CAREER_PROMPTS.find(
  ...
  static getPromptsByCategory(
    category: CareerPrompt["category"],
  ): CareerPrompt[] {
