...
export const RIDER_WAITE_DECK: TarotCardData[] = [
  // MAJOR ARCANA (22 cards)
  {
    ...
    description:
      "The Fool represents new beginnings and having faith in the future.",
  },
  {
    id: "01-magician",
    name: "The Magician",
    ...
    description:
      "The Magician represents the power to manifest your desires through focused will.",
  },
  {
    ...
    description:
      "The High Priestess represents intuitive wisdom and the mysteries of the subconscious.",
  },
  {
    id: "03-empress",
    name: "The Empress",
    ...
    description:
      "The Empress represents the nurturing, creative force of feminine energy.",
  },
  {
    id: "04-emperor",
    name: "The Emperor",
    ...
    description:
      "The Emperor represents masculine authority and the power of structure.",
  },
  {
    id: "05-hierophant",
    name: "The Hierophant",
    ...
    description:
      "The Hierophant represents spiritual wisdom and traditional values.",
  },
  {
    id: "06-lovers",
    name: "The Lovers",
    ...
    description:
      "The Lovers represents deep connections and important choices in relationships.",
  },
  {
    id: "07-chariot",
    name: "The Chariot",
    ...
    description:
      "The Chariot represents triumph through maintaining focus and determination.",
  },
  {
    id: "08-strength",
    name: "Strength",
    ...
    description:
      "Strength represents inner strength and the power of compassion over force.",
  },
  {
    id: "09-hermit",
    name: "The Hermit",
    ...
    description:
      "The Hermit represents the search for inner truth and enlightenment.",
  },
  {
    ...
    description:
      "The Wheel of Fortune represents the cycles of life and changing fortunes.",
  },
  {
    id: "11-justice",
    name: "Justice",
  ...
  },
  {
    ...
    description:
      "The Hanged Man represents surrender and gaining new perspective through letting go.",
  },
  {
    id: "13-death",
    name: "Death",
    ...
    description:
      "Death represents transformation and the natural cycle of endings and beginnings.",
  },
  {
    id: "14-temperance",
    name: "Temperance",
    ...
    description:
      "Temperance represents balance, moderation, and finding your purpose through patience.",
  },
  {
    id: "15-devil",
    name: "The Devil",
    ...
    description:
      "The Devil represents bondage to material things and the shadow aspects of ourselves.",
  },
  {
    id: "16-tower",
    name: "The Tower",
    ...
    description:
      "The Tower represents sudden change and the breakdown of old structures.",
  },
  {
    id: "17-star",
    name: "The Star",
    ...
    description:
      "The Star represents hope, faith, and spiritual guidance after difficult times.",
  },
  {
    id: "18-moon",
    name: "The Moon",
    ...
    description:
      "The Moon represents illusion, intuition, and the mysterious realm of the subconscious.",
  },
  {
    id: "19-sun",
    name: "The Sun",
    ...
    description:
      "The Sun represents joy, success, and the radiant energy of achievement.",
  },
  {
    id: "20-judgement",
    name: "Judgement",
    ...
    description:
      "Judgement represents rebirth, spiritual awakening, and answering your higher calling.",
  },
  {
    id: "21-world",
    name: "The World",
    ...
    description:
      "The World represents completion, fulfillment, and the successful end of a journey.",
  },
  ...
  },
  {
    ...
    description:
      "The Two of Cups represents partnership and mutual emotional connection.",
  },
  {
    id: "three-cups",
    name: "Three of Cups",
    ...
    description:
      "The Three of Cups represents celebration, friendship, and creative collaboration.",
  },
  {
    id: "four-cups",
    name: "Four of Cups",
    ...
    description:
      "The Four of Cups represents meditation, contemplation, and emotional reevaluation.",
  },
  {
    id: "five-cups",
    name: "Five of Cups",
    ...
    description:
      "The Five of Cups represents regret, disappointment, and learning from loss.",
  },
  {
    id: "six-cups",
    name: "Six of Cups",
  ...
  },
  {
    ...
    description:
      "The Seven of Cups represents choices, opportunities, and the need for focus.",
  },
  {
    id: "eight-cups",
    name: "Eight of Cups",
    ...
    description:
      "The Eight of Cups represents walking away from disappointment to seek fulfillment.",
  },
  {
    id: "nine-cups",
    name: "Nine of Cups",
    ...
    description:
      "The Nine of Cups represents contentment, satisfaction, and wishes fulfilled.",
  },
  {
    id: "ten-cups",
    name: "Ten of Cups",
    ...
    description:
      "The Ten of Cups represents emotional fulfillment and harmonious relationships.",
  },
  {
    id: "page-cups",
    name: "Page of Cups",
  ...
  },
  {
    ...
    description:
      "The Knight of Cups represents romance, creativity, and following your heart.",
  },
  {
    id: "queen-cups",
    name: "Queen of Cups",
    ...
    description:
      "The Queen of Cups represents emotional maturity, compassion, and intuitive wisdom.",
  },
  {
    id: "king-cups",
    name: "King of Cups",
    ...
    description:
      "The King of Cups represents emotional mastery and compassionate leadership.",
  },
  // MINOR ARCANA - PENTACLES (14 cards)
  {
    ...
    description:
      "The Ace of Pentacles represents new opportunities for material success.",
  },
  {
    id: "two-pentacles",
    ...
    description:
      "The Two of Pentacles represents balance, adaptability, and managing multiple priorities.",
  },
  {
    id: "three-pentacles",
    ...
    description:
      "The Three of Pentacles represents teamwork, collaboration, and shared learning.",
  },
  {
    id: "four-pentacles",
    ...
    description:
      "The Four of Pentacles represents financial security, conservatism, and control over resources.",
  },
  {
    id: "five-pentacles",
    ...
    description:
      "The Five of Pentacles represents financial hardship and the need for support.",
  },
  {
    id: "six-pentacles",
    ...
    description:
      "The Six of Pentacles represents generosity, charity, and the balance of giving and receiving.",
  },
  {
    id: "seven-pentacles",
    ...
    description:
      "The Seven of Pentacles represents patience, perseverance, and long-term investment.",
  },
  {
    id: "eight-pentacles",
    ...
    description:
      "The Eight of Pentacles represents dedication to craft, skill development, and mastery.",
  },
  {
    id: "nine-pentacles",
  ...
  },
  {
    ...
    description:
      "The Ten of Pentacles represents wealth, family legacy, and long-term financial security.",
  },
  {
    id: "page-pentacles",
    ...
    description:
      "The Page of Pentacles represents new opportunities for learning and financial growth.",
  },
  {
    id: "knight-pentacles",
    ...
    description:
      "The Knight of Pentacles represents dedication, hard work, and methodical progress.",
  },
  {
    id: "queen-pentacles",
    ...
    description:
      "The Queen of Pentacles represents nurturing abundance, practical wisdom, and resourcefulness.",
  },
  {
    id: "king-pentacles",
    ...
    description:
      "The King of Pentacles represents financial mastery, business success, and generous leadership.",
  },
  // MINOR ARCANA - SWORDS (14 cards)
  {
    ...
    description:
      "The Ace of Swords represents mental clarity and breakthrough moments.",
  },
  {
    id: "two-swords",
    name: "Two of Swords",
    ...
    description:
      "The Two of Swords represents difficult decisions and the need to choose a path forward.",
  },
  {
    id: "three-swords",
    ...
    description:
      "The Three of Swords represents heartbreak, grief, and emotional pain that leads to growth.",
  },
  {
    id: "four-swords",
    name: "Four of Swords",
    ...
    description:
      "The Four of Swords represents rest, meditation, and the need for mental recuperation.",
  },
  {
    id: "five-swords",
    name: "Five of Swords",
    ...
    description:
      "The Five of Swords represents conflict, competition, and the cost of winning at any price.",
  },
  {
    id: "six-swords",
    name: "Six of Swords",
    ...
    description:
      "The Six of Swords represents transition, moving forward, and leaving the past behind.",
  },
  {
    id: "seven-swords",
    ...
    description:
      "The Seven of Swords represents deception, strategy, and getting away with something.",
  },
  {
    id: "eight-swords",
    ...
    description:
      "The Eight of Swords represents mental imprisonment and self-imposed limitations.",
  },
  {
    id: "nine-swords",
    name: "Nine of Swords",
    ...
    description:
      "The Nine of Swords represents anxiety, worry, and the dark night of the soul.",
  },
  {
    id: "ten-swords",
    name: "Ten of Swords",
    ...
    description:
      "The Ten of Swords represents painful endings and the promise of new beginnings.",
  },
  {
    id: "page-swords",
    name: "Page of Swords",
    ...
    description:
      "The Page of Swords represents curiosity, new ideas, and the thirst for knowledge.",
  },
  {
    id: "knight-swords",
    ...
    description:
      "The Knight of Swords represents ambition, action, and swift movement toward goals.",
  },
  {
    id: "queen-swords",
    ...
    description:
      "The Queen of Swords represents independence, clear thinking, and direct communication.",
  },
  {
    id: "king-swords",
    name: "King of Swords",
    ...
    description:
      "The King of Swords represents intellectual mastery, authority, and the pursuit of truth.",
  },
  // MINOR ARCANA - WANDS (14 cards)
  {
    ...
    description:
      "The Ace of Wands represents creative inspiration and new ventures.",
  },
  {
    id: "two-wands",
    name: "Two of Wands",
    ...
    description:
      "The Two of Wands represents planning for the future and making important decisions.",
  },
  {
    id: "three-wands",
    name: "Three of Wands",
    ...
    description:
      "The Three of Wands represents progress, expansion, and looking toward the future.",
  },
  {
    id: "four-wands",
    name: "Four of Wands",
    ...
    description:
      "The Four of Wands represents celebration, harmony, and joyful milestones.",
  },
  {
    id: "five-wands",
    name: "Five of Wands",
    ...
    description:
      "The Five of Wands represents conflict, competition, and diverse viewpoints.",
  },
  {
    id: "six-wands",
    name: "Six of Wands",
    ...
    description:
      "The Six of Wands represents success, achievement, and public recognition.",
  },
  {
    id: "seven-wands",
    name: "Seven of Wands",
    ...
    description:
      "The Seven of Wands represents standing your ground and defending your position.",
  },
  {
    id: "eight-wands",
    name: "Eight of Wands",
    ...
    description:
      "The Eight of Wands represents swift action, rapid progress, and forward momentum.",
  },
  {
    id: "nine-wands",
    name: "Nine of Wands",
    ...
    description:
      "The Nine of Wands represents resilience, persistence, and defending your accomplishments.",
  },
  {
    id: "ten-wands",
    name: "Ten of Wands",
    ...
    description:
      "The Ten of Wands represents burden, responsibility, and approaching completion.",
  },
  {
    id: "page-wands",
    name: "Page of Wands",
    ...
    description:
      "The Page of Wands represents inspiration, discovery, and limitless potential.",
  },
  {
    id: "knight-wands",
    ...
    description:
      "The Knight of Wands represents impulsive action, adventure, and fearless energy.",
  },
  {
    id: "queen-wands",
    name: "Queen of Wands",
    ...
    description:
      "The Queen of Wands represents confidence, courage, and vibrant social energy.",
  },
  {
    id: "king-wands",
    name: "King of Wands",
    ...
    description:
      "The King of Wands represents leadership, vision, and entrepreneurial spirit.",
  },
];
