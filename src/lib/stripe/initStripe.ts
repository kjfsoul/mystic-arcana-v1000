...
export const MYSTIC_PRODUCTS = {
  retrograde_collection: {
    ...
    description: 'Limited edition vintage-inspired fashion pieces aligned with Mercury Retrograde energy. Each piece is designed to help you navigate planetary reflection periods with style and cosmic awareness.',
  ...
  full_moon_crystal_set: {
    ...
    description: 'Powerful crystals charged under the full moon for manifestation and amplification of intentions.',
    price: 6700, // $67.00
    currency: 'usd',
  ...
  eclipse_protection_candles: {
    ...
    description: 'Hand-poured candles infused with protective herbs for eclipse season rituals and energy clearing.',
    price: 2900, // $29.00
    currency: 'usd',
  ...
  saturn_return_journal: {
    ...
    description: 'A comprehensive journal with astrological insights and prompts for navigating your Saturn Return.',
    price: 3200, // $32.00
    currency: 'usd',
  ...
  venus_love_oil: {
    ...
    description: 'Luxurious botanical oil blend for self-love rituals and attracting romantic energy.',
    price: 4200, // $42.00
    currency: 'usd',
  ...
  crystal_starter_kit: {
    ...
    description: 'Curated collection of essential crystals for spiritual practice and energy work.',
    price: 4500, // $45.00
    currency: 'usd',
  ...
  new_moon_intention_set: {
    ...
    description: 'Complete kit with journal, crystals, and candles for new moon manifestation rituals.',
    price: 5500, // $55.00
    currency: 'usd',
  ...
  solstice_celebration_bundle: {
    ...
    description: 'Everything you need to honor the winter solstice with candles, crystals, and ritual tools.',
    price: 7800, // $78.00
    currency: 'usd',
  ...
  tarot_deck_premium: {
    ...
    description: 'Hand-illustrated 78-card tarot deck with cosmic artwork and guidebook.',
    price: 3500, // $35.00
    currency: 'usd',
  ...
  moon_phase_jewelry: {
    ...
    description: 'Elegant jewelry pieces featuring the phases of the moon, perfect for daily cosmic connection.',
    price: 6200, // $62.00
    currency: 'usd',
