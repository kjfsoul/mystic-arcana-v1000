...
import { mockBirthData, mockPlanets, mockHouses } from '@/lib/astrology/interpretations/__tests__/mocks';

describe('LoveInterpreter', () => {
  it('should analyze a love profile and return a complete interpretation', () => {
    const interpretation = LoveInterpreter.analyzeLoveProfile(mockBirthData, mockPlanets, mockHouses);
