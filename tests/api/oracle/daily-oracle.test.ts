...
describe('Daily Oracle API Integration', () => {
  ...
  describe('Successful Oracle Generation', () => {
    it('should return comprehensive daily oracle data structure', async () => {
      const mockOracleResponse: DailyOracleResponse = {
        ...
        data: {
          ...
          dailySpread: {
            ...
            cards: {
              morning: {
                ...
                personalizedMessage: 'As the day begins, The Fool offers Gemini the energy of embracing beginnings and innocence.'
              },
              afternoon: {
                card: {
                  id: 'card-2',
                ...
                personalizedMessage: 'In the height of the day, The Magician guides your Gemini focus toward manifesting power and skill.'
              },
              evening: {
                card: {
                  id: 'card-3',
                  ...
                  meaning_reversed: 'Lack of center, lost inner voice, repressed feelings',
                ...
                personalizedMessage: 'As twilight approaches, The High Priestess invites Gemini to celebrate the lessons of intuition and mystery.'
              }
            },
            overallGuidance: 'Today\'s three-card spread reveals a journey of beginnings, manifestation, intuition, perfectly aligned with your Gemini nature.',
            practicalAdvice: 'Begin with beginnings, focus on manifestation during peak hours, and conclude with intuition for perfect daily balance.'
          },
          
          horoscope: {
            sign: 'Gemini',
            degrees: 24.5,
            daily: 'Today you are feeling mentally agile and socially vibrant. Your quick wit and communication skills open doors to exciting new connections.',
            element: 'Air',
            quality: 'Mutable',
          ...
          cosmicFocus: {
            ...
            recommendation: 'Express yourself clearly and listen deeply to others'
          },
          ...
          overallTheme: 'Today\'s cosmic symphony weaves beginnings, manifestation, intuition through Gemini\'s Air energy under the Waxing Gibbous, creating a day of communication and connection.',
          keyMessage: 'Trust the journey that The Fool reveals, for your Gemini wisdom knows the way forward.',
          actionableAdvice: [
          ...
          affirmation: 'I am aligned with my Gemini power and trust the universe\'s guidance through this Waxing Gibbous.',
      ...
      if (data.data) {
        ...
        expect(data.data.dailySpread.cards.afternoon.card.name).toBe('The Magician');
        expect(data.data.dailySpread.cards.evening.card.name).toBe('The High Priestess');
  ...
  describe('Error Handling', () => {
    it('should handle missing birth data', async () => {
      ...
      expect(data.error).toBe('Birth data is required for personalized oracle reading');
    });
      ...
      const fallbackResponse: DailyOracleResponse = {
        ...
        data: {
          ...
          dailySpread: {
            ...
            overallGuidance: 'Today is filled with potential for growth and discovery.',
  ...
  describe('Data Validation', () => {
    it('should validate zodiac sign compatibility data', async () => {
      const geminiResponse: DailyOracleResponse = {
        ...
        data: {
          ...
          compatibility: {
            bestMatchSign: 'Aquarius',
            challengingSign: 'Virgo',
            relationshipAdvice: 'Variety and intellectual connection energize your relationships today.',
      ...
      expect(data.data?.compatibility.bestMatchSign).toBe('Aquarius');
      expect(data.data?.compatibility.challengingSign).toBe('Virgo');
      expect(data.data?.compatibility.relationshipAdvice).toContain('intellectual');
    });
