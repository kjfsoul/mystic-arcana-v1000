...
describe('Birth Chart Integration', () => {
  ...
  it('should successfully call Python backend and return birth chart data', async () => {
    const mockSvg = '<svg viewBox="0 0 400 400"><circle cx="200" cy="200" r="100" fill="blue"/></svg>';
    const mockSignSummary = 'Your sun is in Cancer, making you intuitive and nurturing.';
  ...
  it('should validate SVG format in response', async () => {
    const validSvg = '<svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg"><circle cx="200" cy="200" r="100" fill="blue"/><text x="200" y="250" text-anchor="middle">Birth Chart</text></svg>';
