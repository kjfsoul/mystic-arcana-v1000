...
describe("Daily Oracle Astrology Horoscopes", () => {
  ...
  describe("Complete Zodiac Horoscope Coverage", () => {
    ...
    it("should provide all 12 horoscopes in single response", async () => {
      ...
      expect(data.data.metadata.elements_covered).toEqual([
        "fire",
        "earth",
        "air",
        "water",
      ]);
      expect(data.data.metadata.modalities_covered).toEqual([
        "cardinal",
        "fixed",
        "mutable",
      ]);
      ...
      const mockTransitResponse = {
        ...
        data: {
          ...
          horoscopes: {
            pisces: {
              daily:
                "With Saturn in your sign trining Uranus, structured innovation flows naturally...",
              transit_specific:
                "Saturn in Pisces brings grounded spirituality to your core identity",
            },
            gemini: {
              daily:
      ...
      const mockPersonalizedResponse = {
        ...
        data: {
          personalized_horoscope: {
            ...
            daily_focus:
              "Your Cancer sun in the 8th house emphasizes transformation...",
            transit_impacts: [
              {
            ...
            personalization_factors: {
              location_influences:
                "West Coast water energy amplifies your Cancer nature",
              birth_time_precision:
                "Accurate birth time enables precise house cusps",
            },
          },
        },
      };
