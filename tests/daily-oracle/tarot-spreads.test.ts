...
describe("Daily Oracle Tarot Spreads Validation", () => {
  ...
  describe("One Card Draw", () => {
    it("should validate single card draw structure", async () => {
        ...
        data: {
          one_card_draw: {
            ...
            card: {
              ...
              interpretation:
                "Today calls for intellectual clarity and honest communication.",
              archetypal_energy:
                "The wise woman who speaks truth with compassion",
              practical_guidance:
                "Trust your intellect while remaining emotionally aware",
              symbolic_notes:
                "The sword points upward, indicating clear mental focus",
            },
          },
        },
      };
      ...
      expect(draw.db_identifier).toMatch(
        /^DB_ENTRY_\d{6}_draw_[a-z_]+_(upright|reversed)$/,
      );
        ...
        data: {
          one_card_draw: {
            ...
            card: {
              ...
              interpretation:
                "Resistance to necessary change may be causing internal tension.",
  ...
  describe("Three Card Spread - Past Present Future", () => {
    it("should validate three card spread structure", async () => {
        ...
        data: {
          three_card_spread: {
            ...
            past: {
              ...
              position_context:
                "Past influences showing patterns of imbalanced relationships",
            ...
            present: {
              ...
              archetypal_energy:
                "Pure life force and authentic self-expression",
            },
            future: {
            ...
            cross_card_interpretation:
              "The journey from imbalanced giving leads to present joy and future abundance",
            surrounding_influence:
              "The Sun illuminates both past lessons and future potential",
            holistic_message:
              "Balance in the past creates radiant present which seeds future prosperity",
          },
        },
      };
      ...
      // Validate structure
      expect(spread.db_identifier).toMatch(
        /^DB_ENTRY_\d{6}_three_card_[a-z_]+$/,
      );
        ...
        data: {
          three_card_spread: {
            ...
            orientation_analysis:
              "Mixed energies suggest transformation through contrast",
          },
        },
      };
  ...
  describe("Celtic Cross Spread", () => {
    it("should validate complete Celtic Cross structure with all 10 positions", async () => {
          ...
          celtic_cross: {
            ...
            positions: {
              present: {
                ...
                interpretation:
                  "You have all the tools needed to manifest your desires",
              },
              challenge: {
                position_number: 2,
                name: "Page of Cups",
                ...
                interpretation:
                  "Emotional blocks are preventing clear intuitive guidance",
              },
              distant_past: {
                position_number: 3,
                name: "Three of Wands",
                ...
                interpretation:
                  "Previous planning efforts provide current foundation",
              },
              possible_outcome: {
                position_number: 4,
                name: "Ten of Cups",
              ...
              immediate_future: {
                ...
                interpretation:
                  "Swift action and clear communication are coming",
              },
              approach: {
                position_number: 7,
              ...
              external_influences: {
                ...
                interpretation:
                  "Hidden influences require intuitive navigation",
              },
              hopes_and_fears: {
                position_number: 9,
                name: "Ace of Wands",
            ...
            cross_analysis: {
              present_challenge_dynamic:
                "Manifestation power meets emotional blocks",
              past_outcome_connection:
                "Previous planning leads to ultimate fulfillment",
              crown_base_tension:
                "Divine guidance supports earthly manifestation",
            ...
            staff_analysis: {
              ...
              hopes_to_outcome:
                "Creative sparks manifest as worldly achievement",
              external_to_final: "Navigating illusion enables true completion",
            },
            holistic_interpretation:
              "A powerful manifestation journey from current magical potential through emotional healing to ultimate worldly achievement",
          },
        },
      };
      ...
      // Validate structure
      expect(spread.db_identifier).toMatch(
        /^DB_ENTRY_\d{6}_celticcross_[a-z_]+$/,
      );
      ...
      requiredPositions.forEach((position) => {
        ...
        expect(spread.positions[position].orientation).toMatch(
          /^(upright|reversed)$/,
        );
  ...
  describe("Tarot Metadata and Tags", () => {
    it("should generate appropriate metadata tags for all spreads", async () => {
      ...
      const hasSpreadTags = metadata.tags.some((tag) =>
        tag.startsWith("spread_"),
      );
      ...
      expect(metadata.card_count.upright + metadata.card_count.reversed).toBe(
        metadata.card_count.total,
      );
