...
class TarotApp {
    ...
    initializeData() {
        this.majorArcana = [
            {"id": 0, "name": "The Fool", "keywords": ["new beginnings", "innocence", "adventure", "leap of faith"], "meanings": {"upright": "New beginnings, spontaneity, innocence", "reversed": "Recklessness, taken advantage of, inconsistency"}},
            {"id": 1, "name": "The Magician", "keywords": ["manifestation", "willpower", "desire", "creation"], "meanings": {"upright": "Manifestation, resourcefulness, power", "reversed": "Manipulation, poor planning, untapped talents"}},
            {"id": 2, "name": "The High Priestess", "keywords": ["intuition", "sacred knowledge", "divine feminine", "subconscious mind"], "meanings": {"upright": "Intuition, sacred knowledge, divine feminine", "reversed": "Secrets, disconnected from intuition, withdrawal"}},
            {"id": 3, "name": "The Empress", "keywords": ["femininity", "beauty", "nature", "abundance"], "meanings": {"upright": "Femininity, beauty, nature, abundance", "reversed": "Creative block, dependence on others"}},
            {"id": 4, "name": "The Emperor", "keywords": ["authority", "structure", "control", "fatherhood"], "meanings": {"upright": "Authority, establishment, structure", "reversed": "Tyranny, rigidity, coldness"}},
            {"id": 5, "name": "The Hierophant", "keywords": ["spiritual wisdom", "religious beliefs", "conformity", "tradition"], "meanings": {"upright": "Spiritual wisdom, religious beliefs, conformity", "reversed": "Personal beliefs, freedom, challenging the status quo"}},
            {"id": 6, "name": "The Lovers", "keywords": ["love", "harmony", "relationships", "choices"], "meanings": {"upright": "Love, harmony, relationships, values alignment", "reversed": "Disharmony, imbalance, misalignment of values"}},
            {"id": 7, "name": "The Chariot", "keywords": ["control", "willpower", "success", "determination"], "meanings": {"upright": "Control, willpower, success, determination", "reversed": "Lack of control, lack of direction, aggression"}},
            {"id": 8, "name": "Strength", "keywords": ["strength", "courage", "persuasion", "influence"], "meanings": {"upright": "Strength, courage, persuasion, influence", "reversed": "Self doubt, low energy, raw emotion"}},
            {"id": 9, "name": "The Hermit", "keywords": ["soul searching", "seeking inner guidance", "looking inward"], "meanings": {"upright": "Soul searching, seeking inner guidance, looking inward", "reversed": "Isolation, loneliness, withdrawal"}},
            {"id": 10, "name": "Wheel of Fortune", "keywords": ["good luck", "karma", "life cycles", "destiny"], "meanings": {"upright": "Good luck, karma, life cycles, destiny", "reversed": "Bad luck, lack of control, clinging to control"}},
            {"id": 11, "name": "Justice", "keywords": ["justice", "fairness", "truth", "cause and effect"], "meanings": {"upright": "Justice, fairness, truth, cause and effect", "reversed": "Unfairness, lack of accountability, dishonesty"}},
            {"id": 12, "name": "The Hanged Man", "keywords": ["surrender", "letting go", "new perspective"], "meanings": {"upright": "Surrender, letting go, new perspective", "reversed": "Delays, resistance, stalling"}},
            {"id": 13, "name": "Death", "keywords": ["endings", "change", "transformation", "transition"], "meanings": {"upright": "Endings, change, transformation, transition", "reversed": "Resistance to change, personal transformation, inner purging"}},
            {"id": 14, "name": "Temperance", "keywords": ["balance", "moderation", "patience", "purpose"], "meanings": {"upright": "Balance, moderation, patience, purpose", "reversed": "Imbalance, excess, self-healing, re-alignment"}},
            {"id": 15, "name": "The Devil", "keywords": ["shadow self", "attachment", "addiction", "restriction"], "meanings": {"upright": "Shadow self, attachment, addiction, restriction", "reversed": "Releasing limiting beliefs, exploring dark thoughts, detachment"}},
            {"id": 16, "name": "The Tower", "keywords": ["sudden change", "upheaval", "chaos", "revelation"], "meanings": {"upright": "Sudden change, upheaval, chaos, revelation", "reversed": "Personal transformation, fear of change, averting disaster"}},
            {"id": 17, "name": "The Star", "keywords": ["hope", "faith", "purpose", "renewal"], "meanings": {"upright": "Hope, faith, purpose, renewal", "reversed": "Lack of faith, despair, self-trust, disconnection"}},
            {"id": 18, "name": "The Moon", "keywords": ["illusion", "fear", "anxiety", "subconscious"], "meanings": {"upright": "Illusion, fear, anxiety, subconscious", "reversed": "Release of fear, repressed emotion, inner confusion"}},
            {"id": 19, "name": "The Sun", "keywords": ["positivity", "fun", "warmth", "success"], "meanings": {"upright": "Positivity, fun, warmth, success", "reversed": "Inner child, feeling down, overly optimistic"}},
            {"id": 20, "name": "Judgement", "keywords": ["judgement", "rebirth", "inner calling", "absolution"], "meanings": {"upright": "Judgement, rebirth, inner calling, absolution", "reversed": "Self-doubt, inner critic, ignoring the call"}},
            {"id": 21, "name": "The World", "keywords": ["completion", "accomplishment", "travel", "fulfillment"], "meanings": {"upright": "Completion, accomplishment, travel, fulfillment", "reversed": "Seeking personal closure, short-cut to success, delays"}}
        ];

        this.spreads = {
            "Celtic Cross": {
                "positions": 10,
                "positionsMeaning": ["Present situation", "Challenge/Cross", "Distant past/Foundation", "Recent past", "Possible outcome", "Near future", "Your approach", "External influences", "Hopes and fears", "Final outcome"],
                "complexity": "Advanced",
            ...
            "Relationship": {
                "positions": 7,
                "positionsMeaning": ["You", "Your partner", "The relationship", "Strengths", "Challenges", "Advice", "Outcome"],
                "complexity": "Intermediate",
                "readingTime": "20-30 minutes"
            },
            "Career Path": {
                "positions": 5,
                "positionsMeaning": ["Current situation", "Hidden influences", "Guidance", "Possible outcome", "Advice"],
                "complexity": "Intermediate",
        ...
        document.querySelectorAll('.preference-item input').forEach(checkbox => {
            checkbox.addEventListener('change', () => {
                ...
                if (checkbox.checked) {
                    ...
                    this.userProfile.preferences = this.userProfile.preferences.filter(p => p !== checkbox.value);
                }
                this.updateNavigationButtons();
            });
        });
    ...
    validateCurrentStep() {
        switch(this.currentStep) {
            ...
            case 2:
                return this.userProfile.preferences && this.userProfile.preferences.length > 0;
            case 3:
    ...
    getRecommendedSpread() {
        const levelSpreads = this.userLevels[this.userProfile.level]?.recommendedSpreads || ['Daily Guidance'];
        const moodSpreads = this.moodSpreads[this.userProfile.mood] || ['Daily Guidance'];
        
        // Find intersection of level and mood spreads
        const intersection = levelSpreads.filter(spread => moodSpreads.includes(spread));
        const recommended = intersection.length > 0 ? intersection[0] : levelSpreads[0];
    ...
    loadSpreadOptions() {
        ...
        if (container) {
            const availableSpreads = this.userLevels[this.userProfile.level]?.recommendedSpreads || Object.keys(this.spreads);
    ...
    loadReadingHistory() {
        ...
        if (container) {
            if (this.readingHistory.length === 0) {
                container.innerHTML = '<p class="text-secondary">Your journey begins here</p>';
            } else {
                container.innerHTML = this.readingHistory.slice(-3).map(reading => `
    ...
    getFavoriteSpread() {
        ...
        this.readingHistory.forEach(reading => {
            spreadCounts[reading.spreadName] = (spreadCounts[reading.spreadName] || 0) + 1;
        });
        return Object.keys(spreadCounts).reduce((a, b) => spreadCounts[a] > spreadCounts[b] ? a : b);
    }
            ...
            availableSpreads.forEach(spreadName => {
                ...
                card.innerHTML = `
                    ...
                    <div class="spread-positions">
                        ${Array(spread.positions).fill(0).map(() => '<div class="position-dot"></div>').join('')}
                    </div>
    ...
    selectCard(card, element) {
        ...
        this.selectedCards.push({
            ...
            reversed: this.userLevels[this.userProfile.level]?.reversedCards && Math.random() < 0.3
        });
    ...
    generateInterpretations(level) {
        return this.selectedCards.map(selection => {
            const interpretation = this.getCardInterpretation(selection.card, selection.reversed, level);
            return {
                ...selection,
    ...
    displayReading() {
        ...
        if (subtitle) subtitle.textContent = `Tailored for ${this.userProfile.level} level - ${this.userProfile.mood} energy`;
