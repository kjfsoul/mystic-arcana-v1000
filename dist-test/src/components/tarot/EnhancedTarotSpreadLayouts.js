...
export const EnhancedTarotSpreadLayouts = ({
  spreadType,
  cards,
  onCardClick,
  isRevealing = false,
    ...
    const positions = {
      ...
      "celtic-cross": [
        ...
        },
        {
          ...
          rotate: 0,
          label: "External",
          description: "Outside influences",
          size: "small",
        },
        {
          x: 300 * mobileScale,
  ...
  return React.createElement(
      ...
      cards.map((card, index) => {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                "absolute -top-8 left-1/2 transform -translate-x-1/2 text-center pointer-events-none",
            ...
            React.createElement(
              "div",
              {
                ...
                style: {
                  textShadow: showBioluminescence
                    ? "0 0 10px rgba(0, 255, 255, 0.8)"
                    : "none",
                  filter: showBioluminescence
            ...
            position.description &&
              React.createElement(
                ...
                {
                  className:
                    "text-xs text-purple-300 opacity-80 max-w-24 leading-tight",
                },
                position.description,
              ),
          ),
          React.createElement(EnhancedTarotCard, {
            card: card,
          ...
          React.createElement(
            ...
            {
              className:
                "absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-purple-600/80 text-white text-xs px-2 py-1 rounded-full font-bold backdrop-blur-sm",
    ...
    isMobile &&
      ...
      React.createElement(
        ...
        {
          className:
            "absolute bottom-4 left-4 right-4 bg-black/80 backdrop-blur-md rounded-lg p-4 text-xs",
        ...
        React.createElement(
          "h4",
          { className: "text-cyan-300 font-semibold mb-2 text-center" },
          "Position Guide",
        ),
        React.createElement(
          "div",
            ...
            .map((position, index) =>
              React.createElement(
                ...
                React.createElement(
                  ...
                  {
                    className:
                      "bg-purple-600 text-white w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold",
                  },
                  index + 1,
                ),
                React.createElement(
    ...
    React.createElement(
      ...
      {
        className:
          "absolute top-4 left-4 bg-black/60 backdrop-blur-sm rounded-lg p-3 text-sm",
      ...
      React.createElement(
        "div",
        { className: "text-cyan-300 font-semibold capitalize" },
        spreadType.replace("-", " "),
        " Spread",
      ),
      React.createElement(
