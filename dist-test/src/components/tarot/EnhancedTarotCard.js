...
export const EnhancedTarotCard = ({
  card,
  isFlipped = false,
  isReversed = false,
  onFlip,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            "absolute inset-0 w-full h-full backface-hidden rounded-lg overflow-hidden border-2 border-purple-500/30",
          style: {
      ...
      React.createElement(
        ...
        {
          className:
            "absolute inset-0 w-full h-full backface-hidden rounded-lg overflow-hidden border-2 border-amber-500/50",
          style: {
            backfaceVisibility: "hidden",
        ...
        React.createElement(
          ...
          isReversed &&
            React.createElement(
              ...
              {
                className:
                  "absolute top-2 right-2 bg-red-600/90 text-white px-2 py-1 rounded text-xs font-bold z-10",
                style: {
